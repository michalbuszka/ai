...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.4.2504.701 at 18:53 on środa, 16 kwietnia 2025.
	/// </remarks>
	public partial class Model0_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			Gamma vdouble5_use_B = Gamma.Uniform();
			// Message to 'vdouble5' from Sample factor
			vdouble5_F = GammaFromShapeAndScaleOp.SampleAverageConditional(0.5, 1.0);
			// Message to 'vdouble5_marginal' from Variable factor
			this.vdouble5_marginal_F = VariableOp.MarginalAverageConditional<Gamma>(vdouble5_use_B, vdouble5_F, this.vdouble5_marginal_F);
