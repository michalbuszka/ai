...
namespace Models
{
	...
	public partial class Model_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			vdouble2_F = GaussianFromMeanAndVarianceOp.SampleAverageConditional(0.0, 100.0);
			// Message to 'vdouble2_marginal' from Variable factor
			this.vdouble2_marginal_F = VariableOp.MarginalAverageConditional<Gaussian>(vdouble2_use_B, vdouble2_F, this.vdouble2_marginal_F);
